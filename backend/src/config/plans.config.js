    ...
    CHAT_MODELS: [
        {
            ...
            provider: "Google",
            description: "Your everyday AI assistant. Extremely fast and smart. Best for scheduling tasks, reading data, and managing your dashboard.",
            isDefault: true,
            badge: "⚡ Google",
            pricing: {
        ...
        },
        {
            ...
            name: "GPT-4o Mini",
            provider: "OpenAI",
            description: "Your reasoning expert. Excellent at breaking down complex goals, analyzing data, and managing difficult multi-step tasks.",
            isDefault: false,
            badge: "⭐ Recommended",
            pricing: {
                label: "1 credit/request + 2 credits/1k tokens",
