...
// ─────────────────────────────────────────────────────────
// Resend client (lazy init, like nodemailer transporter)
// ─────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────
// Email HTML wrapper — black bg, cyan accents, mono footer
// ─────────────────────────────────────────────────────────
...
export const sendOtpEmail = async ({ to, otp }) => {
    try {
        const emailFrom = process.env.EMAIL_FROM || `TASKTIME <onboarding@resend.dev>`;
        ...
        if (error) {
            console.error("Resend API Error (sendOtpEmail):", error);
...
export const sendPasswordResetEmail = async ({ to, resetLink }) => {
    try {
        ...
        if (error) {
            console.error("Resend API Error (sendPasswordResetEmail):", error);
