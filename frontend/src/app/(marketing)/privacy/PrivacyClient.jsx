        ...
        <div className="min-h-[100dvh] bg-black text-gray-300 -mt-20 pt-[calc(var(--section-spacing)*1.5)] pb-[var(--section-spacing)] px-[var(--container-padding)] overflow-hidden relative selection:bg-cyan-500/30 selection:text-cyan-500">
            ...
            <div className="w-full max-w-3xl mx-auto relative z-10">
                ...
                <div className="mb-16 border-b border-white/10 pb-8">
                    <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 tracking-tighter">Privacy Policy</h1>
                ...
                <div className="bg-white/5 border border-white/10 p-8 md:p-12 rounded-sm relative overflow-hidden">
                    ...
                    <div className="space-y-12 text-base leading-relaxed">
                        ...
                        <section>
                            ...
                            <p>We may collect and process the following Personal Data when you create or use an Account:</p>
                            <BulletList items={[
                                "Name (first and last name, if provided by you).",
                                "Email address (required to register and authenticate your Account).",
                                "Hashed password or authentication credentials — stored only in hashed form using industry-standard methods, never in plain text.",
                            ...
                            <p>In the normal course of using the Service, we process the content you submit:</p>
                            <BulletList items={[
                                "Tasks, to-do items, notes, and descriptions.",
                                "Schedules, events, reminders, deadlines, and related metadata.",
                                "AI prompts and instructions you provide to generate suggestions, schedules, or AI-powered outputs.",
                                "Feedback you provide inside the product (ratings, comments, bug reports).",
                            ...
                            <p>When you access or use the Service, we automatically collect certain technical information ("Usage Data") such as:</p>
                            <BulletList items={[
                                ...
                                "Interaction events (button clicks, features used, configuration changes) for analytics and product improvement.",
                            ]} />
                        ...
                        <section>
                            ...
                            <BulletList items={[
                                "To provide, operate, and maintain the Service, including task management, scheduling, and AI-powered suggestions.",
                                ...
                                "To manage billing and payments via third-party payment processors, issue invoices, and handle subscription status.",
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                The Service offers AI-based functionality to assist with tasks, schedules, and recommendations.
                                When you use these features, we process your prompts, tasks, schedules, and related context
                                ("AI Inputs") and AI-generated responses ("AI Outputs") to deliver the requested functionality.
                            </p>
                            <BulletList items={[
                        ...
                        <section>
                            ...
                            <p>Once retention periods expire, we delete or irreversibly anonymize Personal Data using commercially reasonable measures, subject to technical limitations and legal requirements.</p>
                        ...
                        <section>
                            ...
                            <p className="mt-4 text-gray-400">
                                To exercise your rights or make a data protection request, you may contact us at{" "}
                                <span className="text-cyan-400 font-mono">privacy@tasktime.in</span>. We may need to verify your identity
                                before acting on your request and may decline requests where permitted or required by law. If you are located in the European Union, you also have the right to
                        ...
                        <section>
                            ...
                            <div className="bg-white/5 border border-white/10 rounded-sm p-6 space-y-2 font-mono text-sm">
                                ...
                                <p><span className="text-gray-500">Grievance:</span> <span className="text-cyan-400">grievance@tasktime.in</span></p>
                                <p><span className="text-gray-500">Website:</span> <span className="text-cyan-400">https://tasktime.in</span></p>
                            </div>
                            <p>For all privacy-related enquiries, please contact our Data Protection Officer at privacy@tasktime.in.</p>

                            <SubHeading title="14.1 Grievance Officer (India — DPDP Act 2023)" />
                            <p className="text-gray-400 mb-3">
                            ...
                            <p className="italic text-gray-400">If you are located in a jurisdiction that provides you with the right to lodge a complaint with a data protection authority or the equivalent regulator, you may also have the right to do so if you are dissatisfied with our response.</p>
                        </section>
                        ...
                        <section>
                            <SectionHeading number={15} title="Additional Rights for US Residents (CCPA)" />
                            <p className="mb-4">
                        ...
                        <section>
                            ...
                            <p className="text-gray-400">
                                If an EU Representative has been designated, their contact details will be made available upon request and published in an updated version of this Privacy Policy. In the meantime, EU residents may direct GDPR-related enquiries to our Data Protection Officer at <span className="text-cyan-400 font-mono">privacy@tasktime.in</span>.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="text-gray-400">
                                If you have questions about how your organization uses your data within the Service, please contact your organization’s administrator. TASKTIME’s obligations as a Data Processor in such arrangements are governed by a Data Processing Addendum or equivalent agreement with the relevant organization.
                            </p>
                        </section>
