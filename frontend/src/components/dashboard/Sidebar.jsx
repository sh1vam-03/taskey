    ...
    return (
        <aside className="fixed left-0 top-0 h-screen w-64 bg-black border-r border-white/10 hidden md:flex flex-col z-50">
            ...
            <div className="p-4 border-t border-white/5">
                <div className="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-400 hover:text-white hover:bg-red-950/20 transition-colors cursor-pointer group">
                    <FaSignOutAlt className="w-4 h-4 group-hover:text-red-400" />
                    <span className="text-sm font-medium">Terminate Session</span>
                </div>
                <div className="mt-4 px-4 text-[10px] text-gray-600 font-mono">
                    Output: v0.9.2-beta
                </div>
            </div>
        </aside>
