          ...
          {step === "form" && (
            <form onSubmit={handleContinue} className="flex flex-col gap-5">
              ...
              <input
                ...
                className="border w-full px-4 py-3 text-sm sm:text-base rounded-lg"
                style={{
              ...
              <div className="relative">
                <input
                  ...
                  className="border w-full px-4 py-3 text-sm sm:text-base rounded-lg w-full"
                  style={{
                    backgroundColor: "var(--bg)",
                    borderColor: "var(--border)",
                    color: "var(--text)",
              ...
              <button className="bg-black w-full sm:w-auto text-white py-3 rounded-lg cursor-pointer">
