...
const content = [
    ...
    tbl(
        ...
        [
            ...
            ['Phase 5: AI Pipeline (Tool-Calling Models)', 'October – November 2025', 'LangGraph 5-node graph, all 12 tool definitions, Gemini + GPT-4o-mini integration, streaming SSE', 'Atharv'],
            ['Phase 6: Sarvam-M Custom Router', 'November 2025', 'Custom 4-node JSON routing graph, intent prompt, executor, 95% accuracy achieved', 'Atharv'],
